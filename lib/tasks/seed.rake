  ...
  namespace :seed do
    ...
    task products: :environment do
      ...
      Product.create!(
        ...
        long_description:    'The Powur Consultant Certification gives you the knowledge, skills, and tools you need to succeed in the solar revolution. As a certified Powur Consultant you’ll have access to:<br><br><ul><li>Insider solar industry training to boost the number of homeowners you refer;</li><li>State-of-the-art techniques to grow your team;</li><li>Detailed training to help you maximize the Powur compensation plan, making sure you get the most out of your referrals;</li><li>Plus, crucial success tips you must know to capitalize on the enormous trends of solar energy, and turn your Powur business into an asset that pays income for decades as we shift from dirty to clean energy.</li></ul>Complete your Powur Consultant Registration below to get certified.',
        bonus_volume:        14900,
